        ...
        <div className="relative w-full max-w-lg hover:scale-105 hover:transition-all duration-300">
            <div className={cn(
                ...
                <div className="space-y-2 flex justify-center w-full">
                    <Link
                        href={paymentLink}
                        className={cn("w-full flex rounded-full justify-center gap-2 bg-linear-to-r from-rose-800 to-rose-500 hover:from-roe-800 hover:rose:to-rose-500 text-white border-2 py-2", id === 'pro' ? 'border-rose-900' : 'border-rose-100 from-rose-400 to-rose-500')}
                    >
