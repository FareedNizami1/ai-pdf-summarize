...
import EmptySymmaryState from '@/components/summaries/empty-summary-state';
import SummaryCard from '@/components/summaries/summary-card';
import { Button } from '@/components/ui/button';
import { getSummaries } from '@/lib/summaries';
import { hasReachedUpgradeLimit } from '@/lib/user';
...
export default async function DashboardPage() {
  ...
  const { hasReachedLimit, uploadLimit } = await hasReachedUpgradeLimit(userId);
        ...
        <div className="px-2 py-12 sm:py-24">
            <div className="flex gap-4 mb-8 justify-between">
                ...
                <Button
                    ...
                    hover:from-rose-600 hover:to-rose-800 hover:scale-105 transition-all
            ...
            { hasReachedLimit && (<div className="mb-6">
              ...
              You've reached the limit of {uploadLimit} uploads on the Basic plan.{' '}
                  <Link 
                      href="/#pricing"
                      className='text-rose-800 hover:text-black underline font-medium 
